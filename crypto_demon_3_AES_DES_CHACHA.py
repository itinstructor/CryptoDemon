...
# ------------------------- ENCRYPT TEXT ----------------------------------#
    def encrypt_text(self):
        """Encrypt text"""
        if self.key:
            text = self.plain_text_input.get(1.0, tk.END)
...
# ----------------------- CREATE WIDGETS ----------------------------------#
    def create_widgets(self):
        ...
        self.cha_radio = ttk.Radiobutton(
            self.encryption_frame, text="ChaCha20Poly1305",
            variable=self.var_encryption_method, value="ChaCha20Poly1305")
        ...
        self.cha_radio.grid(row=0, column=2, sticky=tk.W)
